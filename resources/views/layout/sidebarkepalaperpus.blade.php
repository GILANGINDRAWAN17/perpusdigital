...
<body class="bg-[#E2EDED] min-h-screen flex">
    ...
    <aside class="w-64 bg-[#004d4d] text-white flex flex-col sticky top-0 h-screen shrink-0">
        ...
        <div class="bg-[#003d3d] scale-90 border border-white px-4 py-3 flex rounded-lg mx-auto items-center gap-3 cursor-pointer">
        ...
        <nav class="flex-1 space-y-1 mt-8">
            <div class="bg-[#003d3d] border-l-4 border-white px-6 py-3 flex items-center gap-3 cursor-pointer">
            ...
            <a href="#"
                ...
                <i data-lucide="ReceiptText" class="w-5 h-5 opacity-70 group-hover:opacity-100"></i>
                <span>Transaksi</span>
            </a>
            <a href="#"
                class="px-6 py-3 flex items-center gap-3 text-teal-100 hover:bg-[#003d3d] transition-all group">
