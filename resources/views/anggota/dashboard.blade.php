...
<body class="bg-[#E2EDED] min-h-screen flex">
    ...
    <main class="flex-1 p-8 overflow-y-auto">
        ...
        <header class="flex justify-between items-start mb-8">
            <div>
                <h1 class="text-2xl font-bold text-gray-800"><span class="font-light">Halo,</span> {{ Auth::user()->username ?? 'N/A' }}!</h1>
            ...
            <div class="lg:col-span-2 space-y-6">
                <section class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                    <div class="p-4 flex justify-between items-center border-b border-gray-50">
                        ...
                        <a href="#" class="text-[#004d4d] text-xs font-semibold hover:underline">Lihat Selengkapnya</a>
                    </div>
            ...
            <div class="space-y-6">
                <section class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                    <div class="p-4 flex justify-between items-center border-b border-gray-50">
                        ...
                        <a href="#" class="text-[#004d4d] text-[10px] font-semibold hover:underline">Lihat Selengkapnya</a>
                    </div>
