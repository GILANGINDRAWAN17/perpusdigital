    ...
    <main class="flex-1 p-8 overflow-y-auto">
        ...
        <header class="flex justify-between items-start mb-8">
            <div>
                ...
                <p class="text-gray-500 text-sm">Berikut Daftar Riwayat Peminjaman Buku Anda</p>
            </div>
            <div class="flex items-center gap-4">
                ...
                <div
                    class="w-10 h-10 bg-teal-400 rounded-full flex items-center justify-center text-white cursor-pointer overflow-hidden border-2 border-white shadow-sm">
        ...
        <div class="flex gap-4 mb-10">
            ...
            <button
                class="bg-[#00e6cc] px-6 py-3.5 rounded-xl text-white font-semibold shadow-sm flex items-center gap-2 hover:brightness-105 transition">
        ...
        <section class="bg-white rounded-2xl shadow-xl shadow-slate-200/50 overflow-hidden flex flex-col min-h-[500px]">
            ...
            <div class="flex-1 flex flex-col">
                <div class="grid grid-cols-6 bg-[#00e6cc] py-4 px-8 text-white font-bold text-center text-sm">
                    <div>Cover</div>
                    <div>Judul</div>
                    <div>Pinjam</div>
                    <div>Kembali</div>
                ...
                <div class="flex-1 flex flex-col items-center justify-center p-20">
                    <p class="text-slate-500 text-center font-medium">
                        ...
                        <a href="katalog" class="text-[#00e6cc] underline hover:text-[#00c9b3]">(Pinjam dari
                            katalog)</a>
                    </p>
                </div>
            </div>
        ...
        <section class="bg-white rounded-2xl shadow-xl shadow-slate-200/50 overflow-hidden flex flex-col min-h-[500px] mt-10">
            ...
            <div class="flex-1 flex flex-col">
                ...
                <div class="flex-1 flex flex-col items-center justify-center p-20">
                    <p class="text-slate-500 text-center font-medium">
                        Anda belum memiliki riwayat pengembalian buku. <br>
                    </p>
                </div>
            </div>
