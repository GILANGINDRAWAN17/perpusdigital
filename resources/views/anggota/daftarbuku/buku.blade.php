    ...
    <main class="flex-1 p-8 overflow-y-auto">
        ...
        <header class="flex justify-between items-start mb-8">
            <div>
                ...
                <p class="text-gray-500 text-sm">Temukan Buku Favorit Anda</p>
            </div>
        ...
        <div class="flex gap-4 mb-10">
            <div class="relative flex-1 max-w-md shadow-sm">
                ...
                <input type="text" placeholder="Cari buku..."
                    class="w-full pl-12 pr-4 py-3.5 rounded-xl border-none focus:ring-2 focus:ring-[#00e6cc] outline-none">
            </div>
            <button class="bg-[#00e6cc] p-3.5 rounded-xl text-white shadow-sm hover:brightness-105 transition">
                <i data-lucide="list-filter" class="w-6 h-6"></i>
            </button>
            <button
                class="bg-[#00e6cc] px-10 py-3.5 rounded-xl text-white font-bold shadow-sm hover:bg-[#00c9b3] transition">
                Cari
            </button>
        </div>
        ...
        <section class="bg-white rounded-3xl p-8 shadow-xl shadow-slate-200/50">
            ...
            <div class="flex gap-3 mb-10">
                <button class="bg-[#00e6cc] text-white px-8 py-2 rounded-full text-sm font-semibold">Semua</button>
                <button
                    class="bg-[#f8fafc] border border-slate-100 text-slate-500 px-8 py-2 rounded-full text-sm font-medium hover:border-[#00e6cc] hover:text-[#00e6cc] transition">Novel</button>
                <button
                    class="bg-[#f8fafc] border border-slate-100 text-slate-500 px-8 py-2 rounded-full text-sm font-medium hover:border-[#00e6cc] hover:text-[#00e6cc] transition">Komik</button>
                <button
                    class="bg-[#f8fafc] border border-slate-100 text-slate-500 px-8 py-2 rounded-full text-sm font-medium hover:border-[#00e6cc] hover:text-[#00e6cc] transition">Sains</button>
                <button
                    class="bg-[#f8fafc] border border-slate-100 text-slate-500 px-8 py-2 rounded-full text-sm font-medium hover:border-[#00e6cc] hover:text-[#00e6cc] transition">Teknologi</button>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <div class="flex flex-col justify-between flex-1">
                        ...
                        <button
                            class="bg-[#00e6cc] text-white text-xs font-black uppercase tracking-wider py-2.5 px-6 rounded-lg self-start mt-3 hover:bg-[#00c9b3] shadow-md shadow-[#00e6cc]/20 transition-colors">
                            Pinjam
                        </button>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="flex flex-col justify-between flex-1 text-sm">
                        ...
                        <button
                            class="bg-[#00e6cc] text-white text-xs font-black uppercase tracking-wider py-2.5 px-6 rounded-lg self-start mt-3 hover:bg-[#00c9b3] shadow-md shadow-[#00e6cc]/20 transition-colors">Pinjam</button>
                    </div>
                </div>
